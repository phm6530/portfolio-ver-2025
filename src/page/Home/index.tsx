...
const Home = () => {
  ...
  return (
    <>
      {" "}
      {/* Main Bg */}
      <div className=" pt-30 gap-20 " ref={parentsRef}>
        <div
          ref={ref}
          className="flex flex-col layout-center  items-start gap-3  mt-30 mb-10 textContainer w-full"
        >
          <UserCheck2 className="size-9 text-teal-300" />

          <h1 className="text-5xl md:text-6xl leading-15 md:leading-20 font-bold font-Montserrat  break-keep  w-full">
            PHM,
        ...
        <div className="">
          <div className="layout-center flex flex-col gap-10 pb-20 pt-10  z-10">
