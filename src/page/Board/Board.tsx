        ...
        <section className="py-10">
          <div className="flex flex-col gap-3 mb-5">
            <div className="flex gap-3 items-center">
              ...
              <h1 className="text-3xl subtext-gradient">GUEST BOARD</h1>
            </div>

            <p className="text-zinc-700 dark:text-zinc-400 text-sm max-w-[400px] leading-6 border-zinc-400 border-l pl-5">
